...
import blogImg1 from '../images/blogs/blog1.webp';
import blogImg2 from '../images/blogs/blog2.webp';
import Contact from '../../components/Contact';
import { useEffect } from 'react';

const BlogPage = () => {
    useEffect(() => {
    document.title = "Blog - Neofolio";
  }, []);
  const blogPosts = [
    {
      date: 'August 2, 2024',
  ...
  return (
    ...
    <section className="section">
      ...
      <p className='blog-description mb-16'>Explore cutting-edge design innovations that transform ideas into reality</p>
